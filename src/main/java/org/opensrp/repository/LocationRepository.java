...
public interface LocationRepository extends BaseRepository<PhysicalLocation> {
	 ...
	 */
	List<PhysicalLocation> findStructuresByProperties(boolean returnGeometry, String parentId, Map<String, String> properties);
	
	/**
	 * This methods searches for locations using a list of provided location ids. It returns the
