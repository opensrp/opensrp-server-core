...
public class LocationRepositoryImpl extends BaseRepositoryImpl<PhysicalLocation> implements LocationRepository {
    ...
    private Pair<List<String>, Long> getStructuresListLongPair(int limit, Long lastServerVersion, StructureMetadataExample structureMetadataExample) {
    ...
    private Pair<List<String>, Long> getLocationListLongPair(int limit, Long lastServerVersion, LocationMetadataExample locationMetadataExample) {
        int fetchLimit = limit > 0 ? limit : DEFAULT_FETCH_SIZE;
