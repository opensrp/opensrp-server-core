...
public class ClientsRepositoryImpl extends BaseRepositoryImpl<Client> implements ClientsRepository {
    ...
    @Override
    public Pair<List<String>, Long> findAllIds(long serverVersion, int limit, boolean isArchived, Long minTime, Long maxTime) {
    ...
    private Pair<List<String>, Long> getClientListLongPair(int limit, Long lastServerVersion, ClientMetadataExample example) {
