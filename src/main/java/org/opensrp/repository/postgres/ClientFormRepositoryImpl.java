...
public class ClientFormRepositoryImpl extends BaseRepositoryImpl<ClientForm> implements ClientFormRepository {
    ...
    @Override
    public ClientFormService.CompleteClientForm create(@NonNull ClientForm clientForm, @NonNull ClientFormMetadata clientFormMetadata) throws InvalidTransactionException {
        ...
        if (rowsAffected < 1) {
            throw new InvalidTransactionException("ClientForm was not created and transaction cannot continue to created ClientFormMetadata");
        }
    ...
    @Nullable
    @Override
    public ClientFormService.CompleteClientForm create(@NonNull ClientFormService.CompleteClientForm completeClientForm) throws InvalidTransactionException {
