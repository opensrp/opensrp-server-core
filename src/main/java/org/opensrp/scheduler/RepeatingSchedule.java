...
public class RepeatingSchedule {
	...
	public RepeatingSchedule(String subject, int startDelay, TimeUnit startDelayUnit, int repeatInterval,
	    TimeUnit repeatIntervalUnit) {
	...
	public RepeatingSchedule(String subject, int startDelay, TimeUnit startDelayUnit, int repeatInterval,
	    TimeUnit repeatIntervalUnit, Date endTime, Map<String, Object> data) {
		this.SUBJECT = subject;
		this.START_DELAY = startDelay;
		this.REPEAT_INTERVAL = repeatInterval;
		this.START_DELAY_UNIT = startDelayUnit;
