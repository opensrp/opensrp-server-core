...
public class Alert extends BaseDataEntity {
	...
	public Alert(String providerId, String entityId, String beneficiaryType, AlertType alertType, TriggerType triggerType,
	    String triggerName, String triggerCode, DateTime startDate, DateTime expiryDate, AlertStatus alertStatus,
