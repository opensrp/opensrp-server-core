...
public class Schedule {
    ...
    public Schedule(JSONObject json) throws JSONException {
        this(ActionType.valueOf(json.getString("action").toLowerCase()), json.getString("form").split(","),
                json.getString("schedule"), json.getString("milestone"), json.getString("triggerDateField").split(","),
                json.getString("entityType"), json.has("passLogic") ? json.getString("passLogic") : null);
    }

    public Schedule(ActionType action, String[] forms, String schedule, String milestone, String[] triggerDateFields,
                    String entityType, String passLogic) {
        this.action = action;
