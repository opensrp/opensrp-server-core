...
public class ActionService {
    ...
    public List<Alert> findAlertByEntityIdScheduleAndTimeStamp(String entityId, String schedule, DateTime start,
                                                               DateTime end) {
    ...
    public void alertForBeneficiary(String beneficiaryType, String caseID, String anmIdentifier, String scheduleName,
        ...
        allActions.addOrUpdateAlert(new Action(caseID, anmIdentifier,
                ActionData.createAlert(beneficiaryType, scheduleName, visitCode, alertStatus, startDate, expiryDate)));
