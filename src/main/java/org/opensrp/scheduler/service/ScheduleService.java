...
public class ScheduleService {
	...
	public void enroll(String entityId, String scheduleName, String milestone, String referenceDate,
		...
		EnrollmentRequest request = new EnrollmentRequest(entityId, scheduleName, null, parse(referenceDate), null, null,
		        null, milestone, addOrUpdateEventTrackMetadata(null, formSubmissionId, ActionType.enroll));
	...
	public void fulfillMilestone(String entityId, String scheduleName, LocalDate completionDate, String formSubmissionId) {
		boolean successFullyUpdates = updateExistingEnrollmentWithEventTrackMetadata(entityId, scheduleName,
		    formSubmissionId, ActionType.fulfill);
	...
	private boolean updateExistingEnrollmentWithEventTrackMetadata(String entityId, String scheduleName,
