...
public class Search extends BaseEntity {
	...
	public Search(String baseEntityId, String firstName, String middleName, String lastName, DateTime birthdate,
	...
	public Search(String baseEntityId, String firstName, String middleName, String lastName, DateTime birthdate,
	    Boolean birthdateApprox, String gender, String identifierType, String identifier) {
		super(baseEntityId);
		this.firstName = firstName;
		this.middleName = middleName;
		this.lastName = lastName;
	...
	public Search(String baseEntityId, String firstName, String middleName, String lastName, DateTime birthdate,
	    Boolean birthdateApprox, String gender, List<Address> addresses, Map<String, String> identifiers,
