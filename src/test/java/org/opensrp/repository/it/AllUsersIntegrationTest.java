...
public class AllUsersIntegrationTest {
	...
	public void shouldAddUser() throws Exception {
		...
		User domainUser = new User("0001").withUsername("FWA2").withPassword("77ba08ff5832b6c4143c51160b7e9bab7b72d98a")
		        .withSalt("1efa26b9-9cc9-40df-aecb-14836069a8f8").withStatus("active").withPermissions(permissions)
		        .withRoles(roles);
