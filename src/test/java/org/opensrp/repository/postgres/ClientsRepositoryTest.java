...
public class ClientsRepositoryTest extends BaseRepositoryTest {
	...
	public void testGetAll() {
		assertEquals(19, clientsRepository.getAll().size());
	...
	public void testFindAllClients() {
		assertEquals(19, clientsRepository.findAllClients().size());
	...
	public void testFindByCriteria() {
		...
		assertEquals(19, clientsRepository.findByCriteria(searchBean, addressSearchBean).size());
	...
	public void testFindByServerVersion() {
		assertEquals(9, clientsRepository.findByServerVersion(1520935878136l).size());
