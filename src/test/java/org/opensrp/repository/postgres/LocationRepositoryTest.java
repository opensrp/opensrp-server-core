...
public class LocationRepositoryTest extends BaseRepositoryTest {
	...
	public void testFindLocationsByNames() {
		...
		assertEquals(1, locations.size());
		assertEquals("MKB_5", locations.get(0).getProperties().getName());
