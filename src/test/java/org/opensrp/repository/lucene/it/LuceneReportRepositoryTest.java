...
public class LuceneReportRepositoryTest extends BaseIntegrationTest {
	...
	public void shouldSearchUsingAllCriteria() {
		...
		List<Report> actualReports = luceneReportRepository.getByCriteria(BASE_ENTITY_ID, EPOCH_DATE_TIME,
		    new DateTime(DateTimeZone.UTC), REPORT_TYPE, PROVIDER_ID, LOCATION_ID, EPOCH_DATE_TIME,
	...
	public void findByAllCriteriaV2() {
		...
		List<Report> actualReports = luceneReportRepository.getByCriteria(teamIds, PROVIDER_ID, LOCATION_ID, baseEntityIds,
		    EPOCH_DATE_TIME.getMillis(), null, "DESC", 100);
	...
	public void shouldThrowExceptionIfSortOrderNotSpecifiedInV2() {
		...
		expectedReport.setDateEdited(EPOCH_DATE_TIME);
		addObjectToRepository(Collections.singletonList(expectedReport), allReports);
		luceneReportRepository.getByCriteria(null, PROVIDER_ID, LOCATION_ID, BASE_ENTITY_ID, EPOCH_DATE_TIME.getMillis(),
		    null, null, 100);
	}
