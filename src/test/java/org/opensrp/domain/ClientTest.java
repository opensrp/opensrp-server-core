...
public class ClientTest {
	...
	public void testEqualAndHashcodeContract() {
		EqualsVerifier.forClass(Client.class).withIgnoredFields("id", "revision").suppress(Warning.NONFINAL_FIELDS)
	...
	public void testConstructor() {
		...
		Client client = new Client(baseEntityId, firstName, middleName, lastName, birthDate, deathDate, birthDateApprx,
		        deathDateApprox, gender, type, identifier);
		...
		client = new Client(baseEntityId, firstName, middleName, lastName, birthDate, deathDate, birthDateApprx,
		        deathDateApprox, gender);
		assertEquals(firstName, client.getFirstName());
		assertEquals(middleName, client.getMiddleName());
		assertEquals(lastName, client.getLastName());
		assertEquals(birthDate, client.getBirthdate());
