...
public class SearchTest {
	...
	public void testEqualAndHashcodeContract() {
		EqualsVerifier.forClass(Search.class).withIgnoredFields("id", "revision").suppress(Warning.NONFINAL_FIELDS)
	...
	public void testFullName() {
		...
		search = new Search("ee", "", "", null, new DateTime(0l), true, "male", Collections.EMPTY_LIST,
