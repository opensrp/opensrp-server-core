...
public class FormSubmissionProcessorScheduleTest extends TestResourceLoader {
	...
	public void shouldScheduleP1WhenNoneGivenOnEnrollment() throws JsonIOException, IOException, JSONException {
		...
		verify(schService).enroll("8cc8cbca-7c39-4c57-b8c7-5ccd5cf88af7", "PENTAVALENT 1", "penta1", "2014-12-13",
		    "1996b940-181e-46d5-bf8f-630bef2880a9");
	}
	...
	public void shouldEnrollScheduleProperly() throws IOException, JSONException {
		...
		when(mockScheduleService.findAutomatedSchedules(fs.formName()))
		        .thenReturn(scheduleService.findAutomatedSchedules(fs.formName()));
		...
		verify(mockScheduleService).unEnrollFromSchedule("101aab44-5377-4846-95ad-442b857b54d2", fs.anmId(), "PENTAVALENT 1",
		    fs.instanceId());
		verify(mockScheduleService).enrollIntoSchedule("101aab44-5377-4846-95ad-442b857b54d2", "PENTAVALENT 2", "penta2",
		    "2016-09-20", fs.instanceId());
	}
	...
	public void shouldEnrollScheduleForSubforms() throws IOException, JSONException {
		...
		verify(mockScheduleService).enrollIntoSchedule("0aac6d81-b51f-4096-b354-5a5786e406c8", "FW CENSUS", "FW CENSUS",
		    "2015-05-06", fs.instanceId());
		verify(mockScheduleService).enrollIntoSchedule("b19db74f-6e96-4652-a765-5078beb12434", "Psrf", "psrf", "2000-12-12",
		    fs.instanceId());
	}
