...
public class FormEntityConverterTest extends BaseIntegrationTest {
	...
	public void testCreateBaseClient() throws Exception {
		...
		expectedClient.withFirstName("test").withLastName(".").withGender("male")
		        .withBirthdate(new DateTime("1900-01-01").withTimeAtStartOfDay(), false)
		        .withAddress(new Gson().fromJson(addressString, Address.class)).withIdentifier("JiVita HHID", "1234")
	...
	@Test
	public void testValidOpenmrsForm()
	...
	@Test
	public void testInvalidOpenmrsForm()
	        throws IOException, XPathExpressionException, SAXException, ParserConfigurationException {
		FormSubmission fsubmission = getFormSubmissionFor("new_household_registration", 1);
		FormSubmissionMap formSubmissionMap = formAttributeParser.createFormSubmissionMap(fsubmission);
	...
	public void testCreateEvent()
	        throws ParserConfigurationException, SAXException, XPathExpressionException, IOException, ParseException {
		FormSubmission fsubmission = getFormSubmissionFor("new_household_registration", 1);
		FormSubmissionMap formSubmissionMap = formAttributeParser.createFormSubmissionMap(fsubmission);
		Event expectedEvent = new Event().withBaseEntityId(fsubmission.entityId())
		        .withEventDate(new DateTime(FormEntityConstants.FORM_DATE.parse("2015-05-07")))
		        .withEventType(formSubmissionMap.formAttributes().get("encounter_type")).withLocationId("KUPTALA")
		        .withProviderId(formSubmissionMap.providerId()).withEntityType(formSubmissionMap.bindType())
		        .withFormSubmissionId(formSubmissionMap.instanceId());
		
		List<Object> values = new ArrayList<>();
		values.add("2015-05-07");
		
		Obs obs1 = new Obs("concept", "DateTime", "160753AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", null, values, null, "FWNHREGDATE");
		values.clear();
		values.add(2);
		Obs obs2 = new Obs("concept", "Integer", "5611AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", null, values, null, "FWNHHMBRNUM");
	...
	@Test
	public void testGetFieldNameInSubForm()
	        throws IOException, XPathExpressionException, SAXException, ParserConfigurationException {
		String expected = "FWGENDER";
		FormSubmission fsubmission = getFormSubmissionFor("new_household_registration", 1);
		FormSubmissionMap formSubmissionMap = formAttributeParser.createFormSubmissionMap(fsubmission);
		String actual = formEntityConverter.getFieldName(FormEntityConstants.Person.gender,
		    formSubmissionMap.subforms().get(0));
		
		assertEquals(expected, actual);
	}
	
	@Test
	public void testInvalidFieldNameInForm()
	        throws IOException, XPathExpressionException, SAXException, ParserConfigurationException {
		FormSubmission fsubmission = getFormSubmissionFor("new_household_registration", 1);
		FormSubmissionMap formSubmissionMap = formAttributeParser.createFormSubmissionMap(fsubmission);
		String actual = formEntityConverter.getFieldName(FormEntityConstants.Encounter.encounter_date,
		    formSubmissionMap.subforms().get(0));
		assertNull(actual);
	}
	
	@Test
	public void testGetFieldNameUsingEntity()
	        throws IOException, XPathExpressionException, SAXException, ParserConfigurationException {
		String expected = "FWNHHMBRNUM";
		FormSubmission fsubmission = getFormSubmissionFor("new_household_registration", 1);
		FormSubmissionMap formSubmissionMap = formAttributeParser.createFormSubmissionMap(fsubmission);
		String actual = formEntityConverter.getFieldName("concept", "5611AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", null,
		    formSubmissionMap);
	...
	@Test
	public void testGetFieldNameUsingEnitityWithInvalidData()
	        throws IOException, XPathExpressionException, SAXException, ParserConfigurationException {
		FormSubmission fsubmission = getFormSubmissionFor("new_household_registration", 1);
		FormSubmissionMap formSubmissionMap = formAttributeParser.createFormSubmissionMap(fsubmission);
		String actual = formEntityConverter.getFieldName("concept", "5611AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", null,
