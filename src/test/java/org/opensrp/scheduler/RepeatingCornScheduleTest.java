...
public class RepeatingCornScheduleTest {
	...
	RepeatingCronSchedule repeatingCronSchedule = new RepeatingCronSchedule(SUBJECT, START_DELAY, TimeUnit.HOURS,
	        CRON_EXPRESSION);
	...
	public void testConstructor() {
		...
		RepeatingCronSchedule repeatingCronSchedule = new RepeatingCronSchedule(SUBJECT, START_DELAY, TimeUnit.MILLISECONDS,
		        CRON_EXPRESSION, new Date(0l), extraData);
