...
public class ScheduleServiceTest {
	...
	public void shouldEnrollToFirstMilestoneBasedOnScheduleDatesAndReferenceDate() {
		...
		verify(scheduleTrackingService)
		        .enroll(ScheduleBuilder.enrollmentFor("entity_1", "my_schedule", firstMilestone.getName(), "2012-01-01"));
	}
	...
	public void shouldEnrollToSecondMilestoneBasedOnScheduleDatesAndReferenceDate() {
		...
		verify(scheduleTrackingService)
		        .enroll(ScheduleBuilder.enrollmentFor("entity_1", "my_schedule", secondMilestone.getName(), "2012-01-01"));
	}
	...
	public void shouldEnrollToThirdMilestoneBasedOnScheduleDatesAndReferenceDate() {
		...
		verify(scheduleTrackingService)
		        .enroll(ScheduleBuilder.enrollmentFor("entity_1", "my_schedule", thirdMilestone.getName(), "2012-01-01"));
	}
	...
	public void shouldSuccessfullyFulfilMilestone() {
		Enrollment enrollment = ScheduleBuilder.enrollment("entity_1", "my_schedule", "milestone", new DateTime(0l),
		    new DateTime(1l), EnrollmentStatus.ACTIVE, "formSubmission3");
		...
		inOrder.verify(scheduleTrackingService).fulfillCurrentMilestone("entity_1", "my_schedule",
		    new DateTime(1l).toLocalDate(), new Time(localTime));
	}
	...
	public void shouldUnEnroll() {
		...
		InOrder inOrder = Mockito.inOrder(allEnrollments, scheduleTrackingService);
		inOrder.verify(allEnrollments).update(enrollment);
		inOrder.verify(scheduleTrackingService).unenroll("entity_1", asList("my_schedule"));
	}
	...
	public void shouldUnEnrollGivenScheduleList() {
		Enrollment enrollment_1 = ScheduleBuilder.enrollment("entity_1", "my_schedule", "milestone", new DateTime(0l),
		    new DateTime(1l), EnrollmentStatus.ACTIVE, "formSubmission3");
		Enrollment enrollment_2 = ScheduleBuilder.enrollment("entity_1", "my_schedule", "milestone", new DateTime(0l),
		    new DateTime(1l), EnrollmentStatus.ACTIVE, "formSubmission3");
		...
		inOrder.verify(scheduleTrackingService).unenroll("entity_1", asList("schedule_1", "schedule_2"));
	}
