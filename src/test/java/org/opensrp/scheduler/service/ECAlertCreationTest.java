...
public class ECAlertCreationTest {
	...
	public void test() {
		...
		MotechEvent motechEvent = AlertHandlerRoutesTest.Event.of(externalId, scheduleBCG, milestone, WindowName.max)
		        .createMotechEvent();
		...
		verify(healthSchedulerService).alertFor(milestoneEvent.windowName(), entityType, milestoneEvent.externalId(),
		    providerId, milestoneEvent.scheduleName(), milestoneEvent.milestoneName(), milestoneEvent.startOfDueWindow(),
