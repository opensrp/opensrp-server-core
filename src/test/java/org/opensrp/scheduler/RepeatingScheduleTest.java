...
public class RepeatingScheduleTest {
    ...
    RepeatingSchedule repeatingSchedule = new RepeatingSchedule(SUBJECT, START_DELAY, TimeUnit.HOURS, REPEAT_INTERVAL,
    ...
    public void testConstructor() {
        ...
        RepeatingSchedule repeatingSchedule = new RepeatingSchedule(SUBJECT, START_DELAY, TimeUnit.MILLISECONDS,
                REPEAT_INTERVAL, TimeUnit.MILLISECONDS, new Date(0l), extraData);
