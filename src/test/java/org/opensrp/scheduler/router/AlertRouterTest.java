...
public class AlertRouterTest {
	...
	public void shouldManuallyCallActionServiceIfExceptionHappen() throws IOException {
		...
		ActionData actionData = ActionData.createAlert(entityType, SCHEDULE_NAME, MILESTONE_NAME, AlertStatus.defaulted,
	...
	private void assertRouteMatches(String schedule, String milestone, String window, HookedEvent action,
