...
public class AlertTest {
	...
	public void testEqualityAndHashCode() {
		EqualsVerifier.forClass(Alert.class).withIgnoredFields("timeStamp", "revision").suppress(Warning.NONFINAL_FIELDS)
		        .verify();
	}
	...
	public void testExceptionMarkAsClosedWithClosedAlert() {
		Alert alert = new Alert("pr", "en", "ben", Alert.AlertType.notification, Alert.TriggerType.event, "", "",
		        new DateTime(1l), new DateTime(2l), AlertStatus.closed, new HashMap<String, String>());
	...
	public void testExceptionMarkAsClosedWithCompletedAlert() {
		Alert alert = new Alert("pr", "en", "ben", Alert.AlertType.notification, Alert.TriggerType.event, "", "",
		        new DateTime(1l), new DateTime(2l), AlertStatus.complete, new HashMap<String, String>());
	...
	public void testMarkAsClosed() {
		Alert alert = new Alert("pr", "en", "ben", Alert.AlertType.notification, Alert.TriggerType.event, "", "",
		        new DateTime(1l), new DateTime(2l), AlertStatus.normal, new HashMap<String, String>());
