...
INSERT INTO core.structure_metadata (id, structure_id, geojson_id, type, parent_id, uuid, status, server_version, date_created) VALUES (1, 1, '90397', 'Residential Structure', '3734', '41587456-b7c8-4c4e-b433-23a786f742fc', 'ACTIVE', 1542376382851, '2020-09-25T10:00:00');
...
INSERT INTO core.structure_metadata (id, structure_id, geojson_id, type, parent_id, uuid, status, server_version, date_created) VALUES (2, 2, '90398', 'Larval Dipping', '3724', '3970790a-5a00-11ea-82b4-0242ac130003', 'ACTIVE', 1542376382862, '2020-09-26T10:00:00');


SELECT setval('core.structure_server_version_seq',(SELECT max(json->>'serverVersion')::bigint+1 FROM core.structure));